...
class Neural_Network:
    ...
    def Saving_Weights_Bias(self,filename="DiongChenXi_Exp1_Weights"):
        """
...
if __name__ == "__main__":
    ...
    for i in range(epochs):
        E_total = nn.Training_Neural_Network(inputs, outputs,learn_rate=2)

...
ALTER TABLE competitor
    ADD CONSTRAINT ck_comp_gender CHECK ( comp_gender IN ( 'M', 'F', 'U' ) );
    
ALTER TABLE competitor
    ADD CONSTRAINT ck_comp_unistatus CHECK ( comp_unistatus IN ( 'Y', 'N' ) );

ALTER TABLE competitor
    ADD CONSTRAINT ck_comp_ec_relationship CHECK ( comp_ec_relationship IN ( 'P', 'G', 'T', 'F' ) );

...
Serial Code File.
This is the serial algorithm to count unique instances in word files. 
...
int main(int argc, char *argv[])
{
    ...
    ReadFromFile(inputFileName, &pwordList[0], inputFileSize);
    ...
    uniqueCounts = countUnique(pwordList[0], &puniqueWordList[0], inputFileSize);
    ...
    WriteToFile(outputFileName, puniqueWordList[0], uniqueCounts);
...
*/
{
    ...
    uniqueWordList = (char**)malloc(sizeof(char*) * inputSize);
...
*/
{
    ...
    wordList = (char**)malloc(sizeof(char*) * inputSize);
